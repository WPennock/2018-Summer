...
plt.plot(coag,dataset[0][5],'--^',c='xkcd:brown', markerfacecolor='none', label=r'15 mg/L HA')
...
plt.plot(coag,dataset2[0][4],'co', markerfacecolor='none')
plt.plot(coag,dataset[0][5],'^',c='xkcd:brown', markerfacecolor='none', label=r'15 mg/L HA Data')
plt.plot(coag,dataset2[0][5],'^',c='xkcd:brown', markerfacecolor='none')
...
plt.plot(coag,dataset[1][5],'^',c='xkcd:brown', markerfacecolor='none', label=r'15 mg/L HA Data')
...
plt.semilogx(N50[5],dataset[0][5],'^',c='xkcd:brown', markerfacecolor='none', label=r'15 mg/L HA Data')
...
plt.xlabel(r'Coagulant Dose (mg/L)')
plt.ylabel(r'$\overline{\Gamma}_\mathrm{HA\mbox{-}PACl}$')
plt.axis([0, 3, 0, 1])
